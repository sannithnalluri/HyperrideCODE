    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          ...
          const response = await fetch(`http://127.0.0.1:8000/Upload_bike_details?bikename=${formData.bikename}&bikebookingstatus=${false}&currentpickuptime=${formData.currentpickuptime}&currentexpirytime=${formData.currentexpirytime}&bikeFeatures1=${formData.bikeFeatures1}&bikeFeatures2=${formData.bikeFeatures2}&bikeFeatures3=${formData.bikeFeatures3}`, {
            method: 'POST',
            body: formDataToSend,
          });
